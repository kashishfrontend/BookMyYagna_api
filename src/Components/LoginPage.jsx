...
//     newPassword: '',
//     confirmNewPassword: '',
//     loginIdentifier: '', // For login with email or phone
//   });
//   const [resetEmail, setResetEmail] = useState('');
//   const [otp, setOtp] = useState('');
//   const [errors, setErrors] = useState({});
...
//   const validateForm = () => {
//     const newErrors = {};
//     const { fullName, email, phone, password, confirmPassword, resetEmail, otp, newPassword, confirmNewPassword, loginIdentifier } = formData;

//     if (resetStep === 'login') {
//       if (isLogin) {
//         if (loginMethod === 'email') {
//           if (!loginIdentifier) newErrors.loginIdentifier = 'Email is required';
//           else if (!/\S+@\S+\.\S+/.test(loginIdentifier)) newErrors.loginIdentifier = 'Email is invalid';
//         } else {
//           if (!loginIdentifier) newErrors.loginIdentifier = 'Phone number is required';
//           else if (!/^\d{10}$/.test(loginIdentifier)) newErrors.loginIdentifier = 'Phone number must be 10 digits';
//         }
//       } else {
//         // Register validation
...
//     const processedValue = type === 'checkbox' ? checked : String(value);
//     setFormData((prev) => ({
//       ...prev,
//       [name]: processedValue,
//     }));
...
//       // Add email or phone based on what user provided
//       if (formData.email) {
//         registerData.email = String(formData.email).trim();
//       }
//       if (formData.phone) {
//         registerData.phone = String(formData.phone).trim();
//       }


//       const response = await axios.post("/user/registerUser", registerData);
...
//                                       </Button>
//                                       <Button
//                                         variant={loginMethod === 'phone' ? 'primary' : 'outline-primary'}
...
//                         {/* The rest of the reset password components remain the same */}
//                         {resetStep === 'email' && (
//                           <motion.div
//                             key="email"
//                             className="login-form-wrapper"
