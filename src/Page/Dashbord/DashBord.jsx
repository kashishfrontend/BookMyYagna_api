...
import { FaPrayingHands, FaCalendarAlt, FaUsers, FaBell, FaUserCircle, FaBars } from 'react-icons/fa';
import { MdDashboard, MdPayment, MdSettings, MdLogout, MdNotifications, MdEdit, MdClose } from 'react-icons/md';
import AOS from 'aos';
...
const Dashboard = () => {
  ...
  navigate('/');
    ...
    const upcomingBookings = [
        { id: 1, pooja: 'Satyanarayan Katha', date: '30 April 2025', priest: 'Pandit Ramesh Sharma', status: 'Confirmed' },
        { id: 2, pooja: 'Griha Pravesh', date: '5 May 2025', priest: 'Pandit Suresh Joshi', status: 'Pending' },
        { id: 3, pooja: 'Ganesh Pooja', date: '12 May 2025', priest: 'Pandit Krishna Gupta', status: 'Confirmed' }
    ];

    const popularPoojas = [
        { id: 1, name: 'Satyanarayan Katha', duration: '3 hours', price: '₹5,100', image: '/images/satyanarayan.jpg' },
        { id: 2, name: 'Griha Pravesh', duration: '4 hours', price: '₹7,500', image: '/images/grihapravesh.jpg' },
        { id: 3, name: 'Ganesh Pooja', duration: '2 hours', price: '₹3,100', image: '/images/ganesh.jpg' },
        { id: 4, name: 'Diwali Lakshmi Pooja', duration: '2.5 hours', price: '₹4,500', image: '/images/lakshmi.jpg' }
    ];
    ...
    return (
        <>
            <div className="dashboard-container ">
                {/* Mobile Menu Toggle */}
                <div className="mobile-toggle" onClick={() => setShowSidebar(!showSidebar)}>
                    {showSidebar ? <MdClose size={24} /> : <FaBars size={24} />}
                </div>
                {/* For mobilr view */}
                <div className={`sidebar d-block d-md-none ${showSidebar ? 'active' : ''}`}>
                    <div
                    ...
                    <div
                        className={`menu-item ${activeNavItem === 'settings' ? 'active' : ''}`}
                ...
                {/* Sidebar */}
                <div className={`sidebar col-12 col-lg-2 ${showSidebar ? 'show' : 'hide'}`}>
                    <div className="logo-container">
                        <h2 className="logo">BookmyYagna
                        </h2>
                ...
                {/* Main Content */}
                <div className={`main-content col-lg-10 ${showSidebar ? '' : 'expanded'}`}>
                    {/* Top Navigation */}
                    <div className="top-nav">
                        ...
                        <div className="nav-right ">
                            ...
                            <div className="user-profile" onClick={() => setShowProfileModal(true)}>
                                <img src={userData.profileImage} alt="User" className="avatar" />
                                <span className="user-name d-none d-md-inline">{userData.name}</span>
                            </div>
                        </div>
                    </div>
            ...
            <>
                <Container fluid className="dashboard-content">
                    <Row>
                        <Col>
                            <h1 className="welcome-heading" data-aos="fade-right">
                                <span className="namaste">नमस्ते</span>, {userData.name.split(' ')[0]}!
                            </h1>
                    ...
                    <Row className="stats-row">
                        <Col lg={3} md={6} className="stats-col col-6" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <Col lg={3} md={6} className="stats-col col-6" data-aos="zoom-in" data-aos-delay="200">
                            <Card className="stats-card">
                                <Card.Body>
                                    <div className="stats-icon">
                                        <FaPrayingHands />
                        ...
                        <Col lg={3} md={6} sm={6} className="stats-col col-6" data-aos="zoom-in" data-aos-delay="300">
                            <Card className="stats-card">
                                <Card.Body>
                                    <div className="stats-icon">
                                        {/* <FaTempleHindu /> */}
                        ...
                        <Col lg={3} md={6} sm={6} className="stats-col col-6" data-aos="zoom-in" data-aos-delay="400">
                            <Card className="stats-card">
                                <Card.Body>
                                    <div className="stats-icon">
                                        <FaBell />
                                ...
                                <Card.Body className="p-0">
                                    <div className="booking-list">
                                        {upcomingBookings.map(booking => (
                                            <div key={booking.id} className="booking-item" data-aos="fade-up" data-aos-delay={booking.id * 100}>
                                                ...
                                                <div className="booking-details">
                                                    ...
                                                    <p className="priest-name"><FaUsers /> {booking.priest}</p>
                                                </div>
                                                <div className="booking-status">
                                                    <span className={`status ${booking.status.toLowerCase()}`}>
                                                        {booking.status}
                                                    </span>
                                                    <Button variant="outline-primary" className="details-btn">Details</Button>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                        ...
                        <Col lg={5} data-aos="fade-up" data-aos-delay="200">
                            <Card className="calendar-card">
                                <Card.Header className="calendar-header">
                                    ...
                                    <Button variant="link" className="view-all-btn">Full Calendar</Button>
                                </Card.Header>
                                <Card.Body>
                    ...
                    <Row className="mt-4">
                        ...
                        {popularPoojas.map((pooja, index) => (
                            <Col lg={3} md={6} sm={6} key={pooja.id} data-aos="fade-up" data-aos-delay={index * 100}>
                                <Card className="pooja-card">
                                    <div className="pooja-img-container">
                                        <div className="pooja-img-placeholder" style={{ backgroundImage: `url('${pooja.image}')` }}></div>
                                    </div>
                                    <Card.Body>
                                        <Card.Title>{pooja.name}</Card.Title>
                                        <div className="pooja-details">
                                            <span><i className="far fa-clock"></i> {pooja.duration}</span>
                    ...
                    <Row className="mt-4">
                            ...
                            <Card className="testimonial-card">
                                <Card.Body>
                                    ...
                                    <p className="testimonial-text">
                                        "The online pooja service was just like having it at home. The priest was very knowledgeable and guided us through the entire process with devotion."
                                    </p>
                                    <div className="testimonial-author">
                                        <img src="/images/testimonial1.jpg" alt="Author" className="testimonial-avatar" />
                        ...
                        <Col lg={4} md={6} sm={6} data-aos="fade-up" data-aos-delay="200">
                            <Card className="testimonial-card">
                                <Card.Body>
                                    ...
                                    <p className="testimonial-text">
                                        "We booked a Griha Pravesh pooja through this platform and it was a seamless experience. The priest arrived on time with all necessary items."
                                    </p>
                                    <div className="testimonial-author">
                                        <img src="/images/testimonial2.jpg" alt="Author" className="testimonial-avatar" />
                                        <div className="author-info">
                                            <h5>Aditya Singh</h5>
                                            <p>Mumbai</p>
                                        </div>
                        ...
                        <Col lg={4} md={6} sm={6} className='mt-md-3 mt-0' data-aos="fade-up" data-aos-delay="300">
                            <Card className="testimonial-card">
                                <Card.Body>
                                    <div className="quote-icon">
                                        <i className="fas fa-quote-left"></i>
                                    ...
                                    <p className="testimonial-text">
                                        "Booking a pooja for my parents living in another city was so convenient. The digital prasad delivery was an amazing touch to the service."
                                    </p>
                                    <div className="testimonial-author">
                                        <img src="/images/testimonial3.jpg" alt="Author" className="testimonial-avatar" />
                                        <div className="author-info">
                                            <h5>Shreya Patel</h5>
                                            <p>Bangalore</p>
                                        </div>
    ...
    function renderProfileContent() {
        return (
            <Container fluid className="dashboard-content">
                <Row className="mb-4">
                    <Col>
                        <h2 className="section-heading" data-aos="fade-right">My Profile</h2>
                    </Col>
                </Row>
                                        ...
                                        <Col lg={3} md={4}>
                                            <div className="profile-sidebar">
                                                <div className="profile-image-wrap">
                                                    <img src={userData.profileImage} alt="Profile" className="profile-avatar" />
                                                ...
                                                <Nav variant="pills" className="profile-nav  flex-column mt-4">
                                                    <Nav.Item>
                                                        <Nav.Link className='text-dark border' eventKey="personal">Personal Information</Nav.Link>
                                                    </Nav.Item>
                                                    <Nav.Item>
                                                        <Nav.Link className='text-dark border' eventKey="family">Family Members</Nav.Link>
                                                    </Nav.Item>
                                                    <Nav.Item>
                                                        <Nav.Link className='text-dark border' eventKey="notifications">Notifications</Nav.Link>
                                                    </Nav.Item>
                                                    <Nav.Item>
                                                        <Nav.Link className='text-dark border' eventKey="security">Security & Privacy</Nav.Link>
                                                    </Nav.Item>
                                                </Nav>
                                            </div>
                                        </Col>
                                        <Col lg={9} md={8}>
                                            <Tab.Content>
                                                <Tab.Pane eventKey="personal">
                                                    <h4 className="profile-section-title1">Personal Information</h4>
                                                    <Form>
                                                        <Row>
                                                            <Col md={6}>
                                                                <Form.Group className="mb-3">
                                                        ...
                                                        <Row>
                                                            <Col md={4}>
                                                                <Form.Group className="mb-3">
                                                                    ...
                                                                    <Form.Control type="text" defaultValue="Rohtak" />
                                                                </Form.Group>
                                                            </Col>
                                                            <Col md={4}>
                                                                <Form.Group className="mb-3">
                                                                    <Form.Label>State</Form.Label>
                                                                    <Form.Control type="text" defaultValue="Haryana" />
                                                                </Form.Group>
                                                            </Col>
                                                            <Col md={4}>
                                                                <Form.Group className="mb-3">
                                                                    <Form.Label>Pincode</Form.Label>
                                                                    <Form.Control type="text" defaultValue="124001" />
                                                                </Form.Group>
                                                            </Col>
                                                        </Row>
                                                        <div className="d-flex justify-content-end mt-4">
                                                ...
                                                <Tab.Pane eventKey="family">
                                                    <h4 className="profile-section-title">Family Members</h4>
                                                    <div className="family-members">
                                                        <div className="family-member-card">
                                                            <div className="family-member-avatar">
                                                                <img src="/images/family-member1.jpg" alt="Family Member" />
                                                            </div>
                                                        ...
                                                        <div className="family-member-card">
                                                            <div className="family-member-avatar">
                                                                <img src="/images/family-member2.jpg" alt="Family Member" />
                                                            </div>
                                                            <div className="family-member-details">
                                                                <h5>Rohan Rana</h5>
                                                                <p>Son</p>
                                                        ...
                                                        <Button variant="primary" className="add-family-btn">
                                                            <span>+</span> Add Family Member
                                                        </Button>
                                                    </div>
                                                </Tab.Pane>
                                                <Tab.Pane eventKey="notifications">
                                                    <h4 className="profile-section-title">Notification Settings</h4>
                                                    <Form>
                                                        ...
                                                        <Form.Group className="notification-option">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <Form.Check type="switch" id="sms-switch" defaultChecked />
                                                            </div>
                                                        </Form.Group>
                                                        <Form.Group className="notification-option">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <Form.Group className="notification-option">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    ...
                                                                    <p>Receive reminders before scheduled poojas</p>
                                                                </div>
                                                ...
                                                <Tab.Pane eventKey="security">
                                                    <h4 className="profile-section-title">Security & Privacy</h4>
                                                    <Form>
