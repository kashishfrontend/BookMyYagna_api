...
import { Container, Row, Col, Button, Card, Breadcrumb, Accordion } from 'react-bootstrap';
...
import { GiFlowerPot, GiLotus, GiTripleYin, GiMeditation, GiPrayerBeads, GiOmega } from 'react-icons/gi';
...
console.log("pooja id", poojaId)
    ...
    const faqs = [
        {
            ...
            answer: "Yes, you can offer Dakshina and other items to the Pandit Ji after the completion of the puja as a token of respect and gratitude."
        },
        {
            question: "What if I am not able to arrange some of the items under the Home Preparation List?",
            answer: "Don't worry! Our Pandits come prepared with essential items. However, if you need any specific items to be arranged by us, please mention during booking and we can arrange them for an additional cost."
        },
        {
            question: "Can I pay partial amount at the time of booking?",
            answer: "Yes, you can pay a 50% advance amount to confirm your booking and the remaining amount can be paid on the day of the ceremony."
        },
        {
            question: "What happens after puja is booked?",
            answer: "Once your booking is confirmed, our team will contact you to discuss the details, preferred timing, and any special requirements. Our Pandits will arrive at your place on the scheduled day with all the necessary items."
        }
    ];
    ...
    const benefits = [
        ...
        },
        {
            ...
            description: "Increases divine energy, removes past karma, and provides clarity in life.",
            icon: <GiTripleYin className="benefit-icon" />
        },
        {
    ...
    useEffect(() => {
        if (poojaId) {
            axios.get(`https://bookmyyogna.onrender.com/pooja/getPooja/${poojaId}`)
                .then((response) => {
            ...
            <Container>
                <Row className="pooja-detail-section mt-5" style={{ padding: "10px" }}>
                    ...
                    <Col lg={7} className="pooja-detail-content" data-aos="fade-left">
                        ...
                        <div className="pooja-packages-section">
                            <h2 className="section-title" data-aos="fade-up">Pooja Packages</h2>
                                                ...
                                                <Card.Body>
                                                    ...
                                                    <div className="package-details">
                                                        <div className="detail-item">
                                                            ...
                                                            <span className="detail-value">{plan.numberOfDays}</span>
                                                        </div>
                                                        <div className="detail-item">
                                                            <span>Duration</span>
                                                            <span className="detail-value">{plan.durationOfPooja}</span>
                                                        </div>
                                                    </div>
                                                    <div className="know-more">
                                                        <a href="#">Know More <FaChevronRight className="arrow-icon" /></a>
                                                    </div>
                                                </Card.Body>
                                                <Card.Footer>
                            ...
                            <div className="custom-package" data-aos="fade-up">
                                <p>Looking for a custom package? Click here to plan your perfect pooja experience:</p>
                                <Button variant="outline-primary" className="get-quote-btn">Get a Quote</Button>
                            </div>
                        </div>
                    </Col>
                </Row>
                    ...
                    <Col md={12}>
                        ...
                        <div className="promises-container row d-flex flex-wrap ">
                            <div className='col-6 col-md-2'>
                                <div className="promise-item  " data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <div className='  col-6 col-md-2'>
                                <div className="promise-item" data-aos="zoom-in" data-aos-delay="200">
                                    <div className="promise-icon">
                                        <FiCheck />
                                    </div>
                            ...
                            <div className=' col-6 col-md-2 mt-3 mt-md-0'>
                                <div className="promise-item" data-aos="zoom-in" data-aos-delay="300">
                                    <div className="promise-icon">
                                        <FiAward />
                                    </div>
                            ...
                            <div className=' col-6 col-md-2 mt-3 mt-md-0'>
                                <div className="promise-item " data-aos="zoom-in" data-aos-delay="400">
                                    <div className="promise-icon">
                                        <FiShield />
                                    </div>
                            ...
                            <div className=' col-6 col-md-2 mt-3 mt-md-0'>
                                <div className="promise-item " data-aos="zoom-in" data-aos-delay="500">
                                    <div className="promise-icon">
                                        <FiUsers />
                                    </div>
                            ...
                            <div className=' col-6 col-md-2 mt-3 mt-md-0'>
                                <div className="promise-item " data-aos="zoom-in" data-aos-delay="600">
                                    <div className="promise-icon">
                                        <FiClock />
                                    </div>
                ...
                <Row className="jaap-info-section">
                    <Col md={12}>
                        <div className="info-block" data-aos="fade-up">
                            <h3>This Jaap is known to rejuvenate the mind and body, remove karmic doshas, and enhance longevity.</h3>
                            <p>It is highly recommended for individuals facing health issues, prolonged suffering, or dangers related to planetary doshaa such as <strong>Kaal Sarp Dosh</strong>.</p>
                        </div>

                        <div className="info-block" data-aos="fade-up">
                            <h3>How Maha Mrityunjaya Jaap is Performed?</h3>
                            <p>The Maha Mrityunjaya Jaap is conducted by expert Vedic Pandits following <strong>authentic rituals as per the scriptures</strong>. The procedure includes:</p>
                            <ul className="ritual-steps">
                                <li data-aos="fade-right">
                                    <strong>Sankalp Puja & Kalash Naivedyam Puja</strong> - To remove obstacles and invoke divine energy.
                                </li>
                                ...
                                <li data-aos="fade-right" data-aos-delay="200">
                                    <strong>Havan (Fire Ceremony)</strong> - Performed at the end to channel positive energies and seek Lord Shiva's grace.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="info-block" data-aos="fade-up">
                            ...
                            <ul className="timing-info">
                                <li data-aos="fade-right">
                                    <strong>Shravan or Kartik Month</strong> - The most auspicious time dedicated to Lord Shiva.
                                </li>
                                <li data-aos="fade-right" data-aos-delay="100">
                                    <strong>Mondays</strong> - Considered sacred for worshipping Lord Shiva.
                                </li>
                                <li data-aos="fade-right" data-aos-delay="200">
                                    <strong>Auspicious Nakshatra or Personal Janma Nakshatra</strong> - Chosen based on the devotee's birth chart.
                                </li>
                            </ul>
                        </div>
                    </Col>
                ...
                <Row className="benefits-section">
                    ...
                    {poojaData?.benefitsOfPooja && (
                        <Row className="benefits-section">
                            <Col md={12}>
                                <h2 className="section-title" data-aos="fade-up">Benefits of Maha Mrityunjaya Jaap</h2>
                ...
                <Row className="cta-section" data-aos="fade-up">
                    <Col md={12}>
                        <div className="cta-box">
                            ...
                            <p>Perform Maha Mrityunjaya Jaap with the guidance of expert North Indian Vedic Pandits for divine protection and long life.</p>
                            <Button className="book-now-btn">Book your Maha Mrityunjaya Jaap today!</Button>
                        </div>
                    </Col>
                </Row>
                ...
                <Row className="faq-section">
                    <Col md={12}>
                        <h2 className="section-title" data-aos="fade-up">FAQ (Frequently Asked Questions)</h2>
